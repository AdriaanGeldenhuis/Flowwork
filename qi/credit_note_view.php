            ...
            <div class="fw-qi__controls">
                ...
                <div class="fw-qi__menu-wrapper">
                    ...
                    <nav class="fw-qi__kebab-menu" id="kebabMenu">
                        ...
                        <button onclick="if(/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)){window.location.href='/qi/ajax/download_pdf.php?type=credit_note&id=<?= (int)$creditNoteId ?>'}else{window.print()}" class="fw-qi__kebab-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:16px;height:16px;margin-right:8px;">
