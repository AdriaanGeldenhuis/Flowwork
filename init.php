...
if (!defined('CRM_ASSET_VERSION')) {
    define('CRM_ASSET_VERSION', '2026-07-05-crm-glossy-3d');
}

// Centralized QI asset version for cache busting
if (!defined('QI_ASSET_VERSION')) {
    define('QI_ASSET_VERSION', '2026-08-05b-qi-editor-totals');
}

// Centralized Finances asset version for cache busting
if (!defined('FIN_ASSET_VERSION')) {
    define('FIN_ASSET_VERSION', '2026-07-07-journals-unapprove-source');
}
