...
try {
    ...
    echo json_encode(['ok' => false, 'error' => 'GL posting failed, credit was not applied: ' . $e->getMessage()]);
    exit;
}
...
try {
    ...
    echo json_encode(['ok' => true, 'warning' => 'Credit applied, but status refresh failed: ' . $e->getMessage()]);
}