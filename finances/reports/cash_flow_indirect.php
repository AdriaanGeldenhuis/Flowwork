<?php
// /finances/reports/cash_flow_indirect.php
// Legacy report variant, superseded by /finances/reports/cashflow_indirect.php.
...
header('Location: /finances/reports/cashflow_indirect.php', true, 301);
exit;
