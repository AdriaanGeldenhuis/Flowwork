<?php
// /finances/reports/ap_aging.php
// Standalone Accounts Payable Aging report page.
...
define('ASSET_VERSION', '2025-02-10-AP-AGING');
...
<body>
    ...
    (function() {
        ...
        exportBtn.addEventListener('click', function() {
            ...
            const csvRows = [];
            csvRows.push(['Supplier','Current','1-30','31-60','61-90','90+','Total']);
...
');
            ...
            a.href = url;
            a.download = `ap_aging_${reportDate.value}.csv`;
        ...
        function renderReport(data) {
            ...
            html += '<thead><tr><th>Supplier</th><th>Current</th><th>1-30</th><th>31-60</th><th>61-90</th><th>90+</th><th>Total</th></tr></thead>';
            html += '<tbody>';
